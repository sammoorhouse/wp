...
<div class="betterdocs-single-wraper betterdocs-single-bg full-wrapper betterdocs-single-layout2">
	<!-- <h1>Layout 2</h1> -->
	<?php
	...
	<?php } ?>
	<div class="<?php echo implode(' ', $wraper_class); ?>">
		...
		<main id="betterdocs-single-main" class="docs-single-main docs-content-full-main" role="main">
				...
				<?php
					...
					?>
						<div class="betterdocs-credit">
							<p><?php printf(__('Powered by ', 'betterdocs').'<a href="%s" target="_blank">' . __('BetterDocs', 'betterdocs') . '</a>', 'https://betteredocs.co'); ?></p>
						</div>
