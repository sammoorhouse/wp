...
function betterdocs_customize_register_pro( $wp_customize ) {
	...
	$wp_customize->add_control( new BetterDocs_Customizer_Range_Value_Control(
		...
		'label'    => __( 'Content Overlap', 'betterdocs' ),
		'priority' => 16,
		'input_attrs' => array(
			'min'    => 0,
			'max'    => 500,
	...
	$wp_customize->add_control( new BetterDocs_Customizer_Range_Value_Control(
		...
		'label'    => __( 'Article List Title Font Size', 'betterdocs' ),
		'priority' => 34,
		'input_attrs' => array(
			'min'    => 0,
			'max'    => 100,
    ...
    $wp_customize->add_control(new BetterDocs_Separator_Custom_Control($wp_customize, 'betterdocs_reactions_title', array(
