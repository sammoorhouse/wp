        ...
        ?>
            <div class="betterdocs-settings-header">
                <div class="betterdocs-header-full">
					...
					<h2 class="title"><?php _e( 'BetterDocs', 'betterdocs' ); ?></h2>
					
					<div class="betterdocs-header-button">
						<a href="edit.php?post_type=docs&bdocs_view=classic" class="betterdocs-button betterdocs-button-secondary"><?php _e( 'Switch to Classic UI', 'betterdocs' ); ?></a>
						<a href="post-new.php?post_type=docs" class="betterdocs-button betterdocs-button-primary"><?php _e( 'Add New Article', 'betterdocs' ); ?></a>
					</div>
