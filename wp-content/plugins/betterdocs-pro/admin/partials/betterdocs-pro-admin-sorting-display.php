                                            ...
                                            $output .= '<li data-id="'. $doc->ID .'">';
                                                ...
                                                $output .= $doc->title;
                                                    if( $doc->post_status === 'draft' ) {
                                                        $output .= ' <span class="betterdocs-draft">( '. __( 'Draft', 'betterdocs' ) . ' )</span>';
                                                    }
                                                $output .= $edit_post_link ? '</a>' : '</span>';
                                                $output .= '<span>';
                                                    $output .= '<a href="'. get_permalink( $doc->ID, '' ) .'" target="_blank" title="View Article"><span class="dashicons dashicons-external"></span></a>';
                                                    if( $edit_post_link ) {
                                                        $output .= '<a href="post.php?action=edit&post='. $doc->ID .'" title="Edit Article"><span class="dashicons dashicons-edit"></span></a>';
                                                    }
                                                    if( $delete_post_link ) {
                                                        $output .= '<a href="'. get_delete_post_link( $doc->ID, '' ) .'" title="Delete Article"><span class="dashicons dashicons-trash"></span></a>';
                                                    }
                                                $output .= '</span></div>';
                                            $output .= '</li>';
                                        }
