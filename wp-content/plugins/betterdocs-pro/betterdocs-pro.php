 ...
 */
define( 'BETTERDOCS_PRO_VERSION', '1.2.2' );
...
function betterdocs_install_core_notice() {
	...
	?>
		<div class="error notice is-dismissible">
			<p><strong>BetterDocs Pro</strong> requires <strong>BetterDocs</strong> core plugin to be installed. Please get the plugin now! <button id="betterdocs-install-core" class="button button-primary"><?php echo $button_text; ?></button></p>
		</div>
	<?php
	endif;
}
