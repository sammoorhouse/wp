...
function betterdocs_customize_css() {
	...
	<style type="text/css">
		...
		.betterdocs-categories-wrap {
			width: <?php echo get_theme_mod('betterdocs_doc_page_content_width') ?>%;
			max-width: <?php echo get_theme_mod('betterdocs_doc_page_content_max_width') ?>px;
		}
		...
		.docs-item-container { 
			padding-bottom: <?php echo $defaults['betterdocs_doc_page_column_padding_right'] ?>px; 
		}
		...
		.betterdocs-categories-wrap .docs-single-cat-wrap.docs-cat-list-2-box {
			...
			padding-right: <?php echo $defaults['betterdocs_doc_page_column_padding_right'] ?>px;
			padding-left: <?php echo $defaults['betterdocs_doc_page_column_padding_left'] ?>px; 
			padding-bottom: <?php echo $defaults['betterdocs_doc_page_column_padding_bottom'] ?>px; 
		}
		.betterdocs-categories-wrap.betterdocs-category-box .docs-single-cat-wrap p{
			<?php if(!empty($defaults['betterdocs_doc_page_cat_desc_color'])) { ?>
			color: <?php echo $defaults['betterdocs_doc_page_cat_desc_color'] ?>;
			<?php } ?>
		}
		...
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-single-cat-wrap .docs-cat-title-wrap {
			<?php if(!empty($defaults['betterdocs_doc_page_column_borderr_topleft'])) { ?>
			border-top-left-radius: <?php echo $defaults['betterdocs_doc_page_column_borderr_topleft'] ?>px;
			<?php } ?>
			<?php if(!empty($defaults['betterdocs_doc_page_column_borderr_topright'])) { ?>
			border-top-right-radius: <?php echo $defaults['betterdocs_doc_page_column_borderr_topright'] ?>px;
			<?php } ?>
		}
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-single-cat-wrap,
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-single-cat-wrap .docs-item-container {
			<?php if(!empty($defaults['betterdocs_doc_page_column_borderr_bottomright'])) { ?>
			border-bottom-right-radius: <?php echo $defaults['betterdocs_doc_page_column_borderr_bottomright'] ?>px;
			<?php } ?>
			<?php if(!empty($defaults['betterdocs_doc_page_column_borderr_bottomleft'])) { ?>
			border-bottom-left-radius: <?php echo $defaults['betterdocs_doc_page_column_borderr_bottomleft'] ?>px;
			<?php } ?>
		}
		.betterdocs-category-list .betterdocs-categories-wrap .docs-single-cat-wrap,
		.betterdocs-category-box.white-bg .docs-single-cat-wrap,
		.betterdocs-categories-wrap.white-bg .docs-single-cat-wrap {
			<?php if(!empty($defaults['betterdocs_doc_page_column_bg_color'])) { ?>
			background-color: <?php echo $defaults['betterdocs_doc_page_column_bg_color'] ?>;
			<?php } ?>
		}
		.betterdocs-category-box.ash-bg .docs-single-cat-wrap {
			<?php if(!empty($defaults['betterdocs_doc_page_column_bg_color2'])) { ?>
			background-color: <?php echo $defaults['betterdocs_doc_page_column_bg_color2'] ?>;
			<?php } ?>
		}
		...
		.betterdocs-categories-wrap.white-bg .docs-single-cat-wrap.docs-cat-list-2-box:hover {
			<?php if(!empty($defaults['betterdocs_doc_page_column_hover_bg_color'])) { ?>
			background-color: <?php echo $defaults['betterdocs_doc_page_column_hover_bg_color'] ?>;
			<?php } ?>
		}
		.betterdocs-category-box .docs-single-cat-wrap img {
			<?php if(!empty($defaults['betterdocs_doc_page_column_content_space_image'])) { ?>
			margin-bottom: <?php echo $defaults['betterdocs_doc_page_column_content_space_image'] ?>px;
			<?php } ?>
		}
		.betterdocs-category-box .docs-single-cat-wrap .docs-cat-title {
			<?php if(!empty($defaults['betterdocs_doc_page_column_content_space_title'])) { ?>
			margin-bottom: <?php echo $defaults['betterdocs_doc_page_column_content_space_title'] ?>px;
			<?php } ?>
		}
		.betterdocs-category-box .docs-single-cat-wrap p {
			<?php if(!empty($defaults['betterdocs_doc_page_column_content_space_desc'])) { ?>
			margin-bottom: <?php echo $defaults['betterdocs_doc_page_column_content_space_desc'] ?>px;
			<?php } ?>
		}
		.betterdocs-category-box .docs-single-cat-wrap span {
			<?php if(!empty($defaults['betterdocs_doc_page_column_content_space_counter'])) { ?>
			margin-bottom: <?php echo $defaults['betterdocs_doc_page_column_content_space_counter'] ?>px;
			<?php } ?>
		}
		.docs-cat-title > img { 
			height: <?php echo $defaults['betterdocs_doc_page_cat_icon_size_layout1'] ?>px; 
		}
		.betterdocs-category-box .docs-single-cat-wrap img { 
			height: <?php echo $defaults['betterdocs_doc_page_cat_icon_size_layout2'] ?>px; 
		}
		...
		.docs-cat-list-2 .docs-cat-title {
			color: <?php echo $defaults['betterdocs_doc_page_cat_title_color2'] ?>;
		}
		...
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-item-container li svg {
			fill: <?php echo $defaults['betterdocs_doc_page_list_icon_color'] ?>;
		...
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-item-container .docs-sub-cat-title svg {
			fill: <?php echo $defaults['betterdocs_doc_page_subcategory_icon_color'] ?>;
			font-size: <?php echo $defaults['betterdocs_doc_page_subcategory_icon_font_size'] ?>px;
		}
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-sub-cat-title a {
			color: <?php echo $defaults['betterdocs_doc_page_article_subcategory_color'] ?>;
			font-size: <?php echo $defaults['betterdocs_doc_page_article_subcategory_font_size'] ?>px;
		}
		.betterdocs-archive-wrap .betterdocs-categories-wrap .docs-sub-cat-title a:hover {
			color: <?php echo $defaults['betterdocs_doc_page_article_subcategory_hover_color'] ?>;
		}
		...
		.betterdocs-single-bg .betterdocs-content-area {
			...
			<?php } elseif ($defaults['betterdocs_doc_single_content_area_bg_color']) { ?>
		...
		.betterdocs-single-wraper .betterdocs-content-area .docs-single-main {
			padding-top: <?php echo $defaults['betterdocs_doc_single_post_content_padding_top'] ?>px;
			padding-right: <?php echo $defaults['betterdocs_doc_single_post_content_padding_right'] ?>px;
			padding-bottom: <?php echo $defaults['betterdocs_doc_single_post_content_padding_bottom'] ?>px;
			padding-left: <?php echo $defaults['betterdocs_doc_single_post_content_padding_left'] ?>px;
		}
		.betterdocs-single-layout2 .docs-content-full-main .doc-single-content-wrapper {
			padding-top: <?php echo $defaults['betterdocs_doc_single_2_post_content_padding_top'] ?>px;
			padding-right: <?php echo $defaults['betterdocs_doc_single_2_post_content_padding_right'] ?>px;
			padding-bottom: <?php echo $defaults['betterdocs_doc_single_2_post_content_padding_bottom'] ?>px;
			padding-left: <?php echo $defaults['betterdocs_doc_single_2_post_content_padding_left'] ?>px;
		}
		.betterdocs-single-layout3 .docs-content-full-main .doc-single-content-wrapper {
			padding-top: <?php echo $defaults['betterdocs_doc_single_3_post_content_padding_top'] ?>px;
			padding-right: <?php echo $defaults['betterdocs_doc_single_3_post_content_padding_right'] ?>px;
			padding-bottom: <?php echo $defaults['betterdocs_doc_single_3_post_content_padding_bottom'] ?>px;
			padding-left: <?php echo $defaults['betterdocs_doc_single_3_post_content_padding_left'] ?>px;
		}
		.docs-single-title .betterdocs-entry-title {
			font-size: <?php echo $defaults['betterdocs_single_doc_title_font_size'] ?>px;
			color: <?php echo $defaults['betterdocs_single_doc_title_color'] ?>;
		}
		...
		.betterdocs-entry-content .betterdocs-toc {
			margin-bottom: <?php echo $defaults['betterdocs_toc_margin_bottom'] ?>px;
		}
		.sticky-toc-container {
			width: <?php echo $defaults['betterdocs_sticky_toc_width'] ?>px;
		}
		.sticky-toc-container.toc-sticky {
			z-index: <?php echo $defaults['betterdocs_sticky_toc_zindex'] ?>;
			margin-top: <?php echo $defaults['betterdocs_sticky_toc_margin_top'] ?>px;
		}
		...
		.betterdocs-toc > .toc-list li:before {
			padding-top: <?php echo $defaults['betterdocs_doc_single_toc_list_margin_top'] ?>px;
		}
		...
		.betterdocs-social-share .betterdocs-social-share-heading h5 {
			color: <?php echo $defaults['betterdocs_post_social_share_text_color'] ?>;
		}
		...
		.betterdocs-full-sidebar-left {
			background-color: <?php echo $defaults['betterdocs_sidebar_bg_color'] ?>;
		}
		.betterdocs-single-layout1 .betterdocs-sidebar-content .betterdocs-categories-wrap {
			<?php if(!empty($defaults['betterdocs_sidebar_borderr_topleft'])) { ?>
			border-top-left-radius: <?php echo $defaults['betterdocs_sidebar_borderr_topleft'] ?>px;
			<?php } ?>
			<?php if(!empty($defaults['betterdocs_sidebar_borderr_topright'])) { ?>
			border-top-right-radius: <?php echo $defaults['betterdocs_sidebar_borderr_topright'] ?>px;
			<?php } ?>
			<?php if(!empty($defaults['betterdocs_sidebar_borderr_bottomright'])) { ?>
			border-bottom-right-radius: <?php echo $defaults['betterdocs_sidebar_borderr_bottomright'] ?>px;
			<?php } ?>
			<?php if(!empty($defaults['betterdocs_sidebar_borderr_bottomleft'])) { ?>
			border-bottom-left-radius: <?php echo $defaults['betterdocs_sidebar_borderr_bottomleft'] ?>px;
			<?php } ?>
		}
		.betterdocs-sidebar-content .docs-single-cat-wrap .docs-cat-title-wrap {
			background-color: <?php echo $defaults['betterdocs_sidebar_title_bg_color'] ?>;
		}
		.betterdocs-sidebar-content .docs-cat-title > img{
			height: <?php echo $defaults['betterdocs_sidebar_icon_size'] ?>px;
		}
		...
		.betterdocs-sidebar-content .betterdocs-categories-wrap .docs-single-cat-wrap {
			margin-top: <?php echo $defaults['betterdocs_sidebar_title_margin_top'] ?>px;
			margin-right: <?php echo $defaults['betterdocs_sidebar_title_margin_right'] ?>px;
			margin-bottom: <?php echo $defaults['betterdocs_sidebar_title_margin_bottom'] ?>px;
			margin-left: <?php echo $defaults['betterdocs_sidebar_title_margin_left'] ?>px;
		}
		.betterdocs-sidebar-content .betterdocs-categories-wrap, .betterdocs-full-sidebar-left .betterdocs-categories-wrap {
			padding-top: <?php echo $defaults['betterdocs_sidebar_padding_top'] ?>px;
			padding-right: <?php echo $defaults['betterdocs_sidebar_padding_right'] ?>px;
			padding-bottom: <?php echo $defaults['betterdocs_sidebar_padding_bottom'] ?>px;
			padding-left: <?php echo $defaults['betterdocs_sidebar_padding_left'] ?>px;
		}
		...
		.betterdocs-sidebar-content .docs-item-container{
			background-color: <?php echo $defaults['betterdocs_sidbebar_item_list_bg_color'] ?>;
		}
		...
		.betterdocs-sidebar-content .betterdocs-categories-wrap li svg {
			fill: <?php echo $defaults['betterdocs_sidebar_list_icon_color'] ?>;
		...
		.docs-category-listing .docs-list ul li {
			margin-top: <?php echo $defaults['betterdocs_archive_article_list_margin_top'] ?>px;
			margin-right: <?php echo $defaults['betterdocs_archive_article_list_margin_right'] ?>px;
			margin-bottom: <?php echo $defaults['betterdocs_archive_article_list_margin_bottom'] ?>px;
			margin-left: <?php echo $defaults['betterdocs_archive_article_list_margin_left'] ?>px;
		}
		.docs-category-listing .docs-list ul li svg {
			fill: <?php echo $defaults['betterdocs_archive_list_icon_color'] ?>;
		...
		.docs-category-listing .docs-list ul li a:hover {
			color: <?php echo $defaults['betterdocs_sidebar_list_item_hover_color'] ?>;
		}
		...
		.docs-cat-list-2-box img {
			margin-right: <?php echo $defaults['betterdocs_doc_page_column_content_space_image'] ?>px;
		}
		.betterdocs-wraper .betterdocs-search-form-wrap.cat-layout-4 {
			padding-bottom: <?php echo $defaults['betterdocs_live_search_padding_bottom'] + 80 ?>px;
		}
	</style>
	<script>
		jQuery(document).ready(function() {
			...
			var doc_page_column_space = <?php echo $defaults['betterdocs_doc_page_column_space'] ?>;
