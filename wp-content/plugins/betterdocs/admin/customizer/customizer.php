...
function betterdocs_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(new BetterDocs_Separator_Custom_Control(
		...
		'label'	      => esc_html__( 'Table of Content', 'betterdocs' ),
		'priority'   => 132,
    ...
    $wp_customize->add_control(new BetterDocs_Customizer_Toggle_Control($wp_customize, 'betterdocs_post_social_share_facebook', array(
    ...
    $wp_customize->add_control(new BetterDocs_Customizer_Toggle_Control($wp_customize, 'betterdocs_post_social_share_twitter', array(
	...
	$wp_customize->add_control( new BetterDocs_Customizer_Range_Value_Control(
		...
		'label'    => __( 'Feedback Icon Font Size', 'betterdocs' ),
		'priority'   => 173,
		'input_attrs' => array(
			'class'  => '',
			'min'    => 0,
	...
	$wp_customize->add_control(
		...
		array(
			'label'      => __( 'Live Search Background Color', 'betterdocs' ),
	...
	$wp_customize->add_control( new BetterDocs_Title_Custom_Control(
		...
		'label'    => __( 'Live Search Padding', 'betterdocs' ),
		'input_attrs' => array(
...
/**
 * Change customizer settings transport by layout select
 *
 * @return $add_setting array key => value push.
 * 
 * @since    1.0.2
 */
// function betterdocs_customizer_transport_masonry() {
// 	$layout = get_theme_mod('betterdocs_docs_layout_select');
// 	$masonry_layout = BetterDocs_DB::get_settings('masonry_layout');
// 	if($layout == 'layout-1' && $masonry_layout == 1){
// 		$add_setting = array(
// 			'transport' => 'refresh',
// 		);
// 	} else {
...
// 	return $add_setting;
// }
// add_filter( 'betterdocs_doc_page_content_padding_top', 'betterdocs_customizer_transport_masonry' );
// add_filter( 'betterdocs_doc_page_content_padding_right', 'betterdocs_customizer_transport_masonry' );
// add_filter( 'betterdocs_doc_page_content_padding_bottom', 'betterdocs_customizer_transport_masonry' );
// add_filter( 'betterdocs_doc_page_content_padding_left', 'betterdocs_customizer_transport_masonry' );
// add_filter( 'betterdocs_doc_page_content_width', 'betterdocs_customizer_transport_masonry' );
// add_filter( 'betterdocs_doc_page_content_max_width', 'betterdocs_customizer_transport_masonry' );
// add_filter( 'betterdocs_doc_page_column_space', 'betterdocs_customizer_transport_masonry' );
