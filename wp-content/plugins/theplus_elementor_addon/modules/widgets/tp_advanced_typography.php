	 ...
	 protected function render() {
		...
		if($settings['background_based_text_switch']=='yes'){
						...
						foreach($settings["listing_content"] as $item) {
							...
							if($item['marquee_switch']=='yes'){
								...
								if(!empty($item['marquee_type']) && $item['marquee_type']=='on_transition'){
									$loop_tag='span';
									$marquee_class ='tp_adv_typo_'.$item['marquee_direction'];
									$marquee_attr = '';
								}else{
									$loop_tag='marquee';
								}
							...
							if(!empty($item['on_hover_img_reveal_switch']) && $item['on_hover_img_reveal_switch']=='yes'){
								if(!empty($item['adv_hover_img_reveal_style'])){
									...
									$loop_img_reveal_open .='<a class="block__title" data-img="'.$on_hover_img_source.'">';
					...
					if(!empty($advanced_typography_text)){
						...
						if($settings['marquee_switch']=='yes'){
							if(!empty($settings['marquee_type']) && $settings['marquee_type']=='on_transition'){
								$adv_typ_text = '<div id="'.esc_attr($uidat).'" class="tp_adv_typo_'.$settings['marquee_direction'].' text-content-block  tp-adv-typ-marquee '.esc_attr($circular_text_switch).' '.esc_attr($stroke_switch).' '.esc_attr($background_based_text_switch).' '.esc_attr($img_gif_ovly_txtimg_switch).' '.esc_attr($on_hover_img_reveal_switch).' '.esc_attr($text_continuous_animation).' '.esc_attr($animated_class).'" '.$data_attr.' style="white-space: nowrap;'.$text_write_mode.$mix_blend_attr.'" '.$circular_attr.' '.$animation_attr.'>'.htmlspecialchars_decode($loop_text).'</div>';
							}else{
								$marquee_attr='';
							...
							if (!empty($settings['text_link']['url'])){
								$adv_typ_text = '<a id="'.esc_attr($uidat).'" '.$this->get_render_attribute_string( "typo_link_a" ).' class="text-content-block '.esc_attr($circular_text_switch).' '.esc_attr($stroke_switch).' '.esc_attr($background_based_text_switch).' '.esc_attr($img_gif_ovly_txtimg_switch).' '.esc_attr($on_hover_img_reveal_switch).' '.esc_attr($text_continuous_animation).' '.esc_attr($animated_class).'" '.$data_attr.' style="'.$text_write_mode.$mix_blend_attr.' " '.$circular_attr.' '.$animation_attr.'>'.htmlspecialchars_decode($loop_text).'</a>';						
							}else{
								$adv_typ_text ='';
								if(!empty($settings['on_hover_img_reveal_switch']) && $settings['on_hover_img_reveal_switch']=='yes'){
									...
									$adv_typ_text .='<a class="block__title" data-img="'.$on_hover_img_source.'">';
								}
			...
			if(!empty($settings['marquee_switch']) && $settings['marquee_switch'] =='yes'){
				...
				if(!empty($settings['marquee_direction']) && $settings['marquee_direction']=='left'){
					$advanced_typography .='<style>#at'.$id.'.pt-plus-adv-typo-wrapper .tp_adv_typo_left{
					-moz-animation: tp_adv_typo_left-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite !important;
					-webkit-animation: tp_adv_typo_left-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite !important;
					animation: tp_adv_typo_left-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite !important;}
					
					@-moz-keyframes tp_adv_typo_left-at'.$id.' {
					 0%   { -moz-transform: translateX(100%); }
					 100% { -moz-transform: translateX(-100%); }
					}
					@-webkit-keyframes tp_adv_typo_left-at'.$id.' {
					 0%   { -webkit-transform: translateX(100%); }
					 100% { -webkit-transform: translateX(-100%); }
					}
					@keyframes tp_adv_typo_left-at'.$id.' {
					 0%   { 
				...
				if(!empty($settings['marquee_direction']) && $settings['marquee_direction']=='right'){
					$advanced_typography .='<style>#at'.$id.'.pt-plus-adv-typo-wrapper .tp_adv_typo_right{
					-moz-animation: tp_adv_typo_right-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;
					-webkit-animation: tp_adv_typo_right-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;
					animation: tp_adv_typo_right-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;}
					
					@-moz-keyframes tp_adv_typo_right-at'.$id.' {
					 0%   { -moz-transform: translateX(-100%); }
					 100% { -moz-transform: translateX(100%); }
					}
					@-webkit-keyframes tp_adv_typo_right-at'.$id.' {
					 0%   { -webkit-transform: translateX(-100%); }
					 100% { -webkit-transform: translateX(100%); }
					}
					@keyframes tp_adv_typo_right-at'.$id.' {
					 0%   { 
					 -moz-transform: translateX(-100%); 
					 -webkit-transform: translateX(-100%); 
					 transform: translateX(-100%); 		
				...
				if(!empty($settings['marquee_direction']) && $settings['marquee_direction']=='up'){
					$advanced_typography .='<style>#at'.$id.'.pt-plus-adv-typo-wrapper .tp_adv_typo_up{
					-moz-animation: tp_adv_typo_up-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;
					-webkit-animation: tp_adv_typo_up-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;
					animation: tp_adv_typo_up-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;}

					@-moz-keyframes tp_adv_typo_up-at'.$id.' {
					 0%   { -moz-transform: translateY(100%); }
					 100% { -moz-transform: translateY(-100%); }
					}
					@-webkit-keyframes tp_adv_typo_up-at'.$id.' {
					 0%   { -webkit-transform: translateY(100%); }
					 100% { -webkit-transform: translateY(-100%); }
					}
					@keyframes tp_adv_typo_up-at'.$id.' {
					 0%   { 
				...
				if(!empty($settings['marquee_direction']) && $settings['marquee_direction']=='down'){
					$advanced_typography .='<style>#at'.$id.'.pt-plus-adv-typo-wrapper .tp_adv_typo_down{
					-moz-animation: tp_adv_typo_down-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;
					-webkit-animation: tp_adv_typo_down-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;
					animation: tp_adv_typo_down-at'.$id.' '.$settings['marquee_scrolldelay_t'].'s linear infinite;}
					
					@-moz-keyframes tp_adv_typo_down-at'.$id.' {
					 0%   { -moz-transform: translateY(-100%); }
					 100% { -moz-transform: translateY(100%); }
					}
					@-webkit-keyframes tp_adv_typo_down-at'.$id.' {
					 0%   { -webkit-transform: translateY(-100%); }
					 100% { -webkit-transform: translateY(100%); }
					}
					@keyframes tp_adv_typo_down-at'.$id.' {
					 0%   { 
					 -moz-transform: translateY(-100%); 
					 -webkit-transform: translateY(-100%);
					 transform: translateY(-100%); 		
		...
		if(!empty($item['marquee_switch']) && $item['marquee_switch'] =='yes'){
				...
				if(!empty($item['marquee_direction']) && $item['marquee_direction']=='left'){
					...
					-moz-animation: tp_adv_typo_left-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite !important;
					-webkit-animation: tp_adv_typo_left-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite !important;
					animation: tp_adv_typo_left-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite !important;}
				...
				if(!empty($item['marquee_direction']) && $item['marquee_direction']=='right'){
					...
					-moz-animation: tp_adv_typo_right-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;
					-webkit-animation: tp_adv_typo_right-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;
					animation: tp_adv_typo_right-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;}
				...
				if(!empty($item['marquee_direction']) && $item['marquee_direction']=='up'){
					...
					-moz-animation: tp_adv_typo_up-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;
					-webkit-animation: tp_adv_typo_up-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;
					animation: tp_adv_typo_up-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;}
				...
				if(!empty($item['marquee_direction']) && $item['marquee_direction']=='down'){
					...
					-moz-animation: tp_adv_typo_down-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;
					-webkit-animation: tp_adv_typo_down-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;
					animation: tp_adv_typo_down-at'.$id.' '.$item['marquee_scrolldelay_t'].'s linear infinite;}
