...
class ThePlus_Product_ListOut extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'display_catagory',
			[
				'label' => esc_html__( 'Display Catagory', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'catagory_color',
			[
				'label' => esc_html__( 'Catagory Color', 'theplus' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
