    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'condition' => [					
					'blogs_post_listing!' => ['archive_listing','related_product','acf_repeater'],
					'query!' => ['post'],
					'post_taxonomies!' => '',
				],
			]
