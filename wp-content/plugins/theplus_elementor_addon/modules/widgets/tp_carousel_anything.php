...
class ThePlus_Carousel_Anything extends Widget_Base {
    ...
    protected function render() {
		...
		if(!empty($settings['slider_responsive_tablet']) && $settings['slider_responsive_tablet']=='yes'){				
			...
			$data_slider .=' data-tablet_autoplay_speed="'.esc_attr(!empty($settings["tablet_autoplay_speed"]["size"]) ? $settings["tablet_autoplay_speed"]["size"] : 1500).'"';
		...
		if(!empty($settings['slider_responsive_mobile']) && $settings['slider_responsive_mobile']=='yes'){
			...
			$data_slider .=' data-mobile_autoplay_speed="'.esc_attr(!empty($settings["mobile_autoplay_speed"]["size"]) ? $settings["mobile_autoplay_speed"]["size"] : 1500).'"';
