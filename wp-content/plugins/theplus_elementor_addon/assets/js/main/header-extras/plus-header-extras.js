...
( function( $ ) {
	...
	$(document).ready(function(){
		var musicbar=$(".header-plus-music-toggle"),
			bgmusic=musicbar.data("bgmusic"),
			bgmusic_load=musicbar.data("bgmusic_load"),
			bgmusic_volume=musicbar.data("bgmusic_volume");
		if(bgmusic){
	...
	var WidgetHeaderExtras = function($scope, $) {
		...
		$(".header-extra-toggle-click").on( "click", function(e) {
			e.preventDefault();
