	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, 'f0b74a49290040049a60850cd2834116', '9efdc7b607310546890913da6675c64a');
BVAccount::updateApiPublicKey($this->settings, 'f0b74a49290040049a60850cd2834116');
			}
