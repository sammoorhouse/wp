...
if ( ! defined( 'BUDDYBOSS_SAP_PLUGIN_VERSION' ) ) {
	define( 'BUDDYBOSS_SAP_PLUGIN_VERSION', '1.3.5' );
}
 ...
 * @return void
 */
add_action( 'plugins_loaded', 'BUDDYBOSS_SAP_init', 0 );
...
if ( !function_exists( 'register_buddyboss_menu_page' ) ) {
	...
	function register_buddyboss_menu_page() {
		...
		add_menu_page( 'BuddyBoss', 'BuddyBoss', 'manage_options', 'buddyboss-settings', '', buddyboss_sap()->assets_url . '/images/logo.svg', 3 );
...
require_once('includes/bub-wp-user-export-gdpr.php');
