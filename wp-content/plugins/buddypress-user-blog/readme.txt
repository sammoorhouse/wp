...
= 1.3.5 =
* Fix - Videos added via UserBlog plugin editer were not appearing for non-admin users

= 1.3.4 =
* Fix - Compatibility with BuddyBoss Platform
* Fix - Issues with data saving

= 1.3.3 =
* New - Updated fontawesome version
* Fix - Show the message when image has a large size 
* Fix - Made 'recommended the post' string translatable 
* Fix - php warnings when BuddyPress is not active
* Fix - Missing category name on single post page

= 1.3.2 =
* New - Allow text alignment in editor
* Fix - First post not appearing on tablet device under user profile
* Fix - Fixed full width video embed issue
* Fix - Fix PHP Warning when no excluded categories set
* Fix - Published in... is missing category
* New - Added support for GDPR - WP Core Export and Erase user data for BuddyPress User Blog
