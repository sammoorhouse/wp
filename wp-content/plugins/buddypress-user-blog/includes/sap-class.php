...
//			wp_enqueue_script( 'bp-user-blog-main', buddyboss_sap()->assets_url . '/js/bp-user-blog.js', array( 'jquery' ), '1.0.3', true );
			wp_enqueue_script( 'bp-user-blog-main', buddyboss_sap()->assets_url . '/js/bp-user-blog.js', array( 'jquery' ), BUDDYBOSS_SAP_PLUGIN_VERSION, true );
			...
			$translation_array = array(
				...
				'justifyLeft'               => __( 'left justify', 'bp-user-blog'),
				'justifyCenter'             => __( 'center justify', 'bp-user-blog'),
				'justifyRight'              => __( 'right justify', 'bp-user-blog'),
				'justifyFull'               => __( 'full justify', 'bp-user-blog'),
                ...
                'exceed_max_files_per_batch' => sprintf( __( 'You can upload a maximum of %s photos in one', 'bp-user-blog' ), buddyboss_sap()->option( 'files_per_batch' ) ),
                        ...
                        if(!empty( $create_new_post_page ) && $create_new_post_page == get_the_ID()) {
							...
							wp_enqueue_script( 'fitvids', buddyboss_sap()->assets_url . '/js/fitvids.js', array(), '1.1', true );
