                    ...
                    <div id="learndash-course-header" class="bb-lms-header">
                        ...
                        <div class="flex bb-position">
                            ...
                            <div class="sfwd-course-nav">
                                ...
                                $current             = time();
                                $expire_string       = ( $expire_date_calc > $current ) ? 'Expires at' : 'Expired at';

                                if ( $expire_date_calc > 0 && abs( intval( $expire_access_days ) )  > 0 && ( !empty( $user_id ) ) ) { ?>
                                    <div class="sfwd-course-expire">
                                        <span data-balloon-pos="up" data-balloon="<?php _e( $expire_string, 'buddyboss-theme' ); ?>"><i class="bb-icons bb-icon-watch-alarm"></i><?php echo $expire_date; ?></span>
                                    </div>
                                <?php } ?>
