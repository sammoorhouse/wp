            ...
            <div class="bb-course-preview-content">
                    ...
                    <div class="bb-course-member-wrap flex align-items-center">
                        <span class="bb-course-members"> <?php
	                        ...
	                        foreach ( $course_members as $course_member ) :
                                ...
                                <img class="round"
                                     src="<?php echo get_avatar_url( $course_member->ID, array( 'size' => 96 ) ); ?>"
                                     alt=""/><?php
		                        $count ++;
	                        endforeach; ?>
						</span>
						...
						<?php
						if ( sizeof( $course_members ) > 3 ) { ?>
                            <span class="members">
                            <span class="members-count-g"><?php
							_e( '+', 'buddyboss-theme' );
							echo sizeof( $course_members ) - 3; ?>
                            </span><?php
                ...
                <div class="bb-button-wrap">
					...
					if ( empty( $course_progress ) && $course_progress < 100 ) {
						...
						$btn_advance_label = __( 'Start ', 'buddyboss-theme' ) . __( LearnDash_Custom_Label::get_label( 'course' ), 'buddyboss-theme' );
