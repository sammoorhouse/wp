        ...
        <div class="bb-cover-list-item <?php echo $class_price_type; ?> <?php echo $class_content_type; ?>">
                    ...
                    <div class="bb-course-cover">
                        <a title="<?php the_title_attribute(); ?>" href="<?php the_permalink(); ?>" class="bb-cover-wrap">
							...
							if( is_user_logged_in() && isset($has_access) && $has_access ) {
								...
								echo '<div class="ld-status ld-status-progress ld-primary-background">' . __( 'Start ', 'buddyboss-theme' ) . __( LearnDash_Custom_Label::get_label( 'course' ) , 'buddyboss-theme' ) . '</div>';
			...
			<?php endif; ?>
                ...
                <div class="bb-card-course-details">
					...
					$total_lessons = $lessons_count > 1 ? sprintf( __( '%s ', 'buddyboss-theme' ) . __( LearnDash_Custom_Label::get_label( 'lessons' ) , 'buddyboss-theme' ) , $lessons_count ) : sprintf( __( '%s ', 'buddyboss-theme' ) . __( LearnDash_Custom_Label::get_label( 'lesson' ) , 'buddyboss-theme' ) , $lessons_count );

					if( $lessons_count > 0 ) {
						echo '<div class="course-lesson-count">' . $total_lessons . '</div>';
					} else {
						echo '<div class="course-lesson-count">' . __( '0 ', 'buddyboss-theme' ) . __( LearnDash_Custom_Label::get_label( 'lessons' ) , 'buddyboss-theme' ) . '</div>';
					}
					?>
